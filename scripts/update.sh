...
" 2>/dev/null || echo "  ⚠ Remove coderaft-vault from docker-compose.yml manually" >&2
    ...
    # Write vault override file if not present (migration path: install.sh may
    # not have written it for older fresh installs without the override approach)
...
VAULTOVERRIDE
    ...
    # Compose args for vault-related calls
